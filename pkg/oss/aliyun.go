...
func NewDefaultAliOss() Driver {
	aliConfig := AliConfig{
		AccessKey: conf.Conf.Oss.AliYun.AccessKey,
		SecretKey: conf.Conf.Oss.AliYun.SecretKey,
		Bucket:    conf.Conf.Oss.AliYun.Bucket,
		Endpoint:  conf.Conf.Oss.AliYun.Endpoint,
	}
